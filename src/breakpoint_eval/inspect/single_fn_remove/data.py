...
def get_single_fn_remove_dataset(
    ...
    for problem in problems:
        ...
        prompt = f"""\
{world_model_section}Your task is to implement a missing Python function in a codebase. Your goal is to make all tests in the codebase pass. Follow these instructions carefully:
