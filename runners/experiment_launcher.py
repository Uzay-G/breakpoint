...
# Configuration
MODELS = ["o3"]
REMOVE_DATA = "/home/ubuntu/breakpoint/data/hard_functions_90percentile.json"
# DISCOVERY_DATA = "/home/ubuntu/breakpoint/data/o4_corruptions.json"
OUTPUT_DIR = "/home/ubuntu/breakpoint/real_results/"
WORKERS = 19  # Default number of concurrent workers
...
async def main():
    ...
    if args.test:
        ...
        await run_experiment("remove", REMOVE_DATA, 4, 1, n_problems=1)
        return
