...
CONSOLIDATED_FILES = {
    ...
    / "consolidated_results_remove_all.jsonl",
    "remove_all_normalized": BASE_DIR
    / "consolidated_results"
    / "consolidated_results_remove_all_normalized.jsonl",
    "remove_all_with_tools": BASE_DIR
    / "consolidated_results"
    / "consolidated_results_remove_all_with_tools.jsonl",
    "remove_all_with_tools_filters": BASE_DIR
    / "consolidated_results"
    / "consolidated_results_remove_all_with_tools_filters.jsonl",
    "remove_16iter_4tests": BASE_DIR
    / "consolidated_results"
    / "consolidated_results_remove_16iter_4tests_openai.jsonl",
    "discovery_all": BASE_DIR
    / "consolidated_results"
    / "consolidated_results_discovery_all.jsonl",
    "discovery_all_normalized": BASE_DIR
    / "consolidated_results"
    / "consolidated_results_discovery_all_normalized.jsonl",
    "discovery_all_with_tools": BASE_DIR
    / "consolidated_results"
    / "consolidated_results_discovery_all_with_tools.jsonl",
    "discovery_all_with_tools_filters": BASE_DIR
    / "consolidated_results"
    / "consolidated_results_discovery_all_with_tools_filters.jsonl",
    "discovery_all_with_tools_filters_recompute": BASE_DIR
    / "consolidated_results"
    / "consolidated_results_discovery_all_with_tools_filters_recompute.jsonl",
    "discovery_16iter_4tests": BASE_DIR
    / "consolidated_results"
    / "consolidated_results_discovery_16iter_4tests_openai_rh.jsonl",
}
...
PLOT_SCRIPTS = [
    ...
    },
    {
        ...
        "args": [
            "final_results/multi_corrupt_1.jsonl",
            "final_results/multi_corrupt_2.jsonl",
            "final_results/multi_corrupt_4.jsonl",
        ],  # Uses hardcoded paths
    },
    {
...
def main():
    ...
    if contrastive_path.exists():
        for run_config in CONTRASTIVE_SCRIPT["runs"]:
            total_count += 1
            if run_script(
                contrastive_path, run_config["args"], run_config["description"]
            ):
                success_count += 1
